  ...
  <div style="min-height: 650px;">
    ...
    <div class="row justify-content-center">
      <div class="card" style="width: 20rem">
        ...
        <div class="card-body">
          <div class="row justify-content-center">
          <img src="<?php echo empty($result['avatar_path'] )?"uploads/blank_image.jpg": $result['avatar_path']?>" style="height:60%; width:60%;" class="m-auto rounded-circle" alt="person profile">
          </div>
          <br>
    ...
    <div class="row justify-content-center">
      ...
      <a onclick="return confirm('Are you sure youw want to delete this record!')" href="delete.php?id=<?php echo $result['attendee_id']  ?>" class="btn btn-danger">delete</a>
